  ...
  return (
    <div className="flex flex-col items-center justify-center flex-1 w-full opacity-0 animate-[fadeIn_0.5s_ease-out_forwards] translate-y-4">
      <div className="mb-6 flex items-center justify-center">
        <div className="bg-white/70 rounded-[2rem] w-32 h-32 sm:w-36 sm:h-36 flex items-center justify-center shadow-lg drop-shadow-2xl p-1">
          <img
            src="/images/BermainLaptop.png"
            alt="Oxigen Logo"
